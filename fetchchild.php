...
while($row = mysqli_fetch_array($result))
{
 ...
 $sub_array[] = '<div contenteditable class="update" data-id="'.$row["Id"].'" data-column="email">' . $row["email"] . '</div>';
  $sub_array[] = '<div contenteditable class="update" data-id="'.$row["Id"].'" data-column="email">' . $row["age"] . '</div>';
  $sub_array[] = '<div contenteditable class="update" data-id="'.$row["Id"].'" data-column="email">' . $row["sex"] . '</div>';
   $sub_array[] = '<div contenteditable class="update" data-id="'.$row["Id"].'" data-column="email">' . $row["note"] . '</div>';
