...
<body>
   ...
   <div>
    ...
    <center>
        <buttonn onclick="window.location.href = 'Menu_Lesson.html';" class="btnAddChild"> Lesson </buttonn>
        <buttonn onclick="window.location.href = 'Menu_Exercice.php';" class="btnYourChild"> Exercice </buttonn>
        <buttonn herf="Exam.php" class="btnyouraccountParents"> Exam </buttonn>
    </center>
