...
<body>
  ...
  <style type="text/css">
    ...
    <audio id="First">
          <source src="audio/i-eat-hamburger-today1578425521.mp3" type="audio/mp3">
      </audio>
      
     <audio id="Second">
        <source src="audio/batman-help-people1578427712.mp3" type="audio/mp3">
      </audio>
    
      <audio id="Third">
        <source src="audio/there-is-someone-at-the1578429187.mp3" type="audio/mp3">
      </audio>

      <audio id="Four">
        <source src="audio/there-are-many-apples-on1578429995.mp3" type="audio/mp3">
      </audio>

      <audio id="Five">
        <source src="audio/the-joker-is-a-dangerous1578480278.mp3" type="audio/mp3">
      </audio>
...
<form >
<b><i>  </i></b><br>
<input type="checkbox" /> I Eat hamburger today. <br>
<input type="checkbox" /> She eat for hour today . <br>
<input type="checkbox" />I Bit my fureur today <br>

<i> <b> </b> </i> <br>
<input type="checkbox" />Fan Ship with purple . <br>
<input type="checkbox" /> Oldman heap People . <br>
<input type="checkbox"/>Batman Help People <br>

<b><i>  </i></b><br>
<input type="checkbox" /> Here is moon at the floor. <br>
<input type="checkbox" /> There is someone at the door. <br>
<input type="checkbox" />This is somoenoe to be poor.<br>

<i><b>  </b> </i> <br>
<input type="checkbox" />There are many apples on the tree. <br>
<input type="checkbox"/>We are ungly apples on the three.<br>
<input type="checkbox" />They are funny turle on the tree.<br>
<i> <b>  </b> </i><br>
<input type="checkbox" />The Poker is a famous criminal. <br>
<input type="checkbox" />The Joker is a dangerous criminal. <br>
<input type="checkbox" />The "Car" is a dangerous journal.<br>



<input type=button value="Vérifier" onclick="qcm(0,'100001010100010')"/>
<input type="text" name="t" size="20" ></input>
<input type="reset" value="Annuler" />
<input type="button" onclick="solution(0,'100001010100010')" value="Solution" />
<a href="Exercice_1_2.php" class="button">Next</a>
