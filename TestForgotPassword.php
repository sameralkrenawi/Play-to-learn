                 ...
                 <tr style="border-collapse:collapse;"> 
                  <td width="600" align="left" style="padding:0;Margin:0;"> 
                   <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;"> 
                     ...
                     <tr style="border-collapse:collapse;"> 
                      <td align="left" class="es-m-txt-l" style="padding:0;Margin:0;padding-left:25px;padding-right:25px;"><h1 style="Margin:0;line-height:45px;mso-line-height-rule:exactly;font-family:arial, \'helvetica neue\', helvetica, sans-serif;font-size:30px;font-style:normal;font-weight:bold;color:#000000;">Hi <b>'.$repons['username'].'</b> ,your new password: <b>'.$new_pass.'</b> &nbsp;</h1></td> 
                     </tr> 
                     <tr style="border-collapse:collapse;"> 
...
while($repons = mysqli_fetch_array($exec_requete) and $temp=1){
    if($repons['email']==$username){
        ...
        $new_pass = rand();
        $new_pass_crypt=password_hash($new_pass,PASSWORD_DEFAULT);
        $sql = "UPDATE MyParents SET password='$new_pass_crypt' WHERE email = '$username'";
        $resultat = mysqli_query($db,$sql);
        if ($resultat == FALSE) { 
            echo "Echec de l'exécution de la requête.<br />"; 
        } 
